...
# Needs to be 40 char plus
QUESTION_TITLE = "Progress affiliate; global leaders citizenry livelihoods. Bloomberg committed, results aid developing nations collaborative cities urban health solutions. The Elders incubation."


SECOND_QUESTION_TITLE = "Jane Addams local solutions smart cities Angelina Jolie climate change. Open source our grantees and partners insurmountable challenges social challenges Rockefeller. Immunize stakeholders initiative Oxfam, solutions, action Arab Spring contribution."

# Needs to be 150 char plus
